...
contract ybETH_DepositETHTest is ybETH_BaseTest {
  ...
  function testRevert_WhenPrecisionLoss() external {
    ...
    ybeth.depositETH{value: 1_000 ether}(address(this));
    // Assert
    ...
    ybeth.depositETH{value: 1 wei}(alice);
    vm.stopPrank();
  }
  ...
  function testCorrectness_WhenDepositETHSuccessfully() external {
    ...
    // Deposit to ybETH
    ybeth.depositETH{value: 1_000 ether}(alice);
    vm.stopPrank();
    // Assert
